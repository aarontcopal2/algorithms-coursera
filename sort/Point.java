...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        if (degenerate(that))
            ...
            return 0;   // if normal slope is calculated, -0.0 may be returned sometimes
        return Double.valueOf(String.format("%.2f", slope(that)));
    }
    ...
    private boolean degenerate(Point that) {
